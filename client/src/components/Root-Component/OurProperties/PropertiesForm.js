  ...
  return (
    <>
      <CCol className="text-end px-4 py-3">
        <CButton className="mx-5" onClick={() => setVisibleForm(true)}>
          ADD ON
        </CButton>
      </CCol>
      ...
      >
        ...
        <CModalBody>
          <CRow>
            <CCol lg={6}>
              <CFormInput
                type="file"
                label={`Upload Resort Image ${resrtImgPrograss}%`}
          ...
          <CRow>
            <CCol lg={6}>
              <CFormInput
                type="file"
                label={`Upload Room Image ${roomImgProgress}%`}
          ...
          <CRow>
            ...
            <CCol className="mt-2" lg={6}>
              <CFormInput
                ...
                type="number"
                value={leftRoom}
                onChange={(e) => setLeftRoom(e.target.value)}
              />
            </CCol>
          </CRow>
          ...
          <CRow>
            <CCol className="mt-2" lg={6}>
              <CFormInput
                label="Room No Of Per night"
                type="number"
                value={roomPerNight}
                onChange={(e) => setRomPerNight(e.target.value)}
              />
            </CCol>
            <CCol className="mt-2" lg={6}>
              <CFormInput
                ...
                type="text"
                value={roomAminities}
                onChange={(e) => setRoomAminities(e.target.value)}
              />
            </CCol>
          </CRow>
            ...
            <CCardBody className="p-4 ">
              <CRow className="text-start">
                <CCol className="mt-2">
                  <CFormCheck
                    type="checkbox"
                    label="Non Cancel / Non Refundable"
                    checked={notCancable}
                    onChange={() => setNotCacable((val) => !val)}
                  />
                </CCol>
                <CCol className="mt-2">
                  <CFormCheck
              ...
              <CRow className="text-start">
                <CCol className="mt-2">
                  <CFormCheck
                    ...
                    label="Bedside Table"
                    checked={besideTable}
                    onChange={() => setBesideTable((val) => !val)}
                  />
                </CCol>
                <CCol className="mt-2">
                  <CFormCheck
              ...
              <CRow className="text-start">
                ...
                <CCol className="mt-2">
                  <CFormCheck
                    ...
                    label="House Keeping"
                    checked={houseKeping}
                    onChange={() => setHouseKeping((val) => !val)}
                  />
                </CCol>
              </CRow>
              ...
              <CRow className="text-start">
                <CCol className="mt-2">
                  <CFormCheck
                    ...
                    label="Mosquito Net"
                    checked={mosquito}
                    onChange={() => setMosquito((val) => !val)}
                  />
                </CCol>
                <CCol className="mt-2">
                  <CFormCheck
                    type="checkbox"
                    label="24hr hot & cold shower"
                    checked={hour24ColdShower}
                    onChange={() => set24HourColdShower((val) => !val)}
                  />
                </CCol>
              </CRow>
              <CRow className="text-start">
                ...
                <CCol className="mt-2">
                  <CFormCheck
                    ...
                    checked={airCodition}
                    onChange={() => setAirCondition((val) => !val)}
                  />
                </CCol>
              </CRow>
            </CCardBody>
        ...
        <CModalFooter>
          ...
          <CButton color="primary" onClick={saveResortInfo}>
            Save Resort
          </CButton>
        </CModalFooter>
      </CModal>
